...
import { styles } from './styles/stylesInfoScreen'
import {
    View,
    Text,
    TouchableOpacity,
        ...
        <View style={styles.container}>
            ...
            <View style={{}}>
                ...
                <View style={{ zIndex: 3, paddingVertical: 5 }}>
                    ...
                    <View style={{ width: width*.99, justifyContent: 'center', alignSelf: 'center', borderRadius: 10, height: height *.43 ,backgroundColor:'#fff'}}>
